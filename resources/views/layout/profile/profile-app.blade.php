            ...
            <div class="large-12 columns">
                ...
                <div class="profile-subscribe">
                 ...
                 <div class="profile-share">
                    <div class="share_on_socailsite"></div>
                    <div class="easy-share " data-easyshare   data-easyshare-image data-easyshare-url="http://vdopedia.com">
                        <!-- Facebook -->
                        <button data-easyshare-button="facebook" data-easyshare-text="vdopedia sharing the profile on twitter">
                            <span class="fa fa-facebook" style="color: white; padding-right: 20px;"></span>
                        </button>
                        <button data-easyshare-button="linkedin" data-easyshare-text="vdopedia sharing the profile on twitter">
                            <span class="fa fa-linkedin" style="color: white; padding-right: 20px;"></span>
                        </button>

                       {{--  <span data-easyshare-button-count="facebook">0</span> --}}

                        <!-- Twitter -->
                        <button data-easyshare-button="twitter" data-easyshare-tweet-text="vdopedia sharing the profile on twitter">
            ...
            <div class="row secBg">
                <div class="large-12 columns">
                    ...
                    <div class="description">
                        <p>{{isset($userInfo->bio_description)?$userInfo->bio_description:''}} </p>
                        <div class="site profile-margin">
                            <button><i class="fa fa-globe"></i>Site</button>
                            <a href="#" class="inner-btn">{{isset($userInfo->website_url)?$userInfo->website_url:''}}</a>
                        </div>
