    ...
    <section id="navBar">
        <nav class="sticky-container" data-sticky-container>
            <div class="sticky topnav topnav-dark" data-sticky data-top-anchor="navBar" data-btm-anchor="footer-bottom:bottom" data-margin-top="0" data-margin-bottom="0" style="width: 100%; background: #303030;" data-sticky-on="large">
                <div class="title-bar large-12" data-responsive-toggle="beNav" data-hide-for="large">
                    <button class="menu-icon sidebarCollapse" type="button" data-toggle="offCanvas"></button>
                    <div class="title-bar-title">
                        <img src="images/logo.jpg" width="164px" alt="logo">
                        @if(empty(Auth::user()->id))
                            <a href="{{route('login')}}" class="header_login" title="login link"><div class="button large-12">login</div></a>
                        @endif <br>
                            <input type="search"class="columns hearder-search-class typeahead_header_search" name="search" placeholder="Seach Here your video">

                             <div id="header_searchSuggestion" class="box"align="center"></div>
                    </div>
                </div>
                <div class="show-for-large topbar-full topbar-dark clearfix" data-responsive-toggle="beNav"  id="beNav">
                    ...
                    <div class="top-bar-left toplogo">
                        <ul class="menu">
                            <li class="menu-text">
                                <a href="@if(!empty(Auth::user()->id)){{ route('home')}} @else {{ url('/') }} @endif" title="home page link"><img src="images/logo.jpg" width="164px" alt="logo"></a>
                            </li>
                        </ul>
                    </div>
                    <!-- <div class="top-bar-left topsearch">
                        <div class="search-bar-full">
                            <div align="center" class="float-left">
                                    <input type="search" style="width:500px;" class="search-class typeahead" name="search" placeholder="Seach Here your video"><i style="float: left;" class="fa fa-search"></i>
                                    <div id="searchSuggestion" class="box"align="center"></div>
                            </div>
                        </div>
                    </div> -->
                    <div class="top-bar-left topsearch" style="width: 50%;">
                        <div class="search-bar-full">
                            <div class="input-group">
                                <input id="id_search_textbox" class="input-group-field search-class typeahead" type="search" placeholder="Enter your keyword here ...">
                                <div class="input-group-button icon-btn">
                                    <input class="button result_search_buttton" type="submit" name="submit" value="search">
                                    
                                </div>
                            </div>
                                <div id="searchSuggestion" class="box searchSuggestion"align="center"></div>
                        </div>
                    </div>
                    <div class="top-bar-left topbtn">
                        <div class="top-button">
                            <ul class="menu float-left" style="margin-top: 5px;" >
                                <li>
                                    <a href="{{ route('videoUpload.index') }}" title="video upload link">upload Video</a>
                                </li>
                                @if(!empty(Auth::user()->id))
                                <li class="upl-btn">
                                    <a href="notification" style="text-align: center;" title="video notification link"><i class="fa fa-bell"></i></a>
                                </li>
                                <li class="upl-btn">
                                    <ul class="menu vertical medium-horizontal dropdown" data-responsive-menu="drilldown medium-dropdown" role="menubar" data-dropdown-menu="xwxxk2-dropdown-menu" aria-expanded="false" data-is-click="false">
                                        <li role="menuitem" class="is-dropdown-submenu-parent opens-right" aria-haspopup="true" aria-expanded="false" aria-label="features" data-is-click="false">
                                            ...
                                            <ul class="submenu menu vertical is-dropdown-submenu first-sub" data-submenu="" data-animate="slide-in-down slide-out-up" aria-hidden="true" role="menu">
                                                <li >
                                                    <a href="{{ url('profile/'.base64_encode(Auth::user()->id)) }}" title="author profile link"><img src="{{ asset('images/profile-bg1.png') }}"  class="img-circle" style="border-radius: 50%;height: 30px; width: 30px;">Profile</a>
                                                </li>
                                                <li >
                                                    <a class="dropdown-item" title="logout link" href="{{ route('logout') }}"
                                ...
                                <li class="dropdown-login">
                                    <a class="loginReg" data-toggle="example-dropdown" title="author login/register link" href="{{route('login')}}">login/Register</a>
                                    <div class="login-form">
                                        <h1 class="text-center">Great to have you back!</h1>
                                        ...
                                        {{-- <div data-abide-error class="alert callout" style="display: none;">
                                           <p><i class="fa fa-exclamation-triangle"></i> There are some errors in your form.</p>
                                            ...
                                            <p class="loginclick">New Here ? <a href="{{ route('register') }}" style="font-size: 14px;" class="button expanded">Create A New Acoount</a></p>
                                        </form>
                                    </div>
                                </li>
                            </ul>
        ...
        <div id="dismiss"> X </div>
           ...
           <ul class="vertical menu off-menu" data-responsive-menu="drilldown" style="margin-top:60px">
                    <li class="has-submenu">
                        <a href="@if(!empty(Auth::user()->id)){{ route('home')}} @else {{ url('/') }} @endif"title="home page link"><i class="fa fa-home"></i>Home</a>
                         <a  data-video_status="trending" title="trending video link" onclick="increase()" class="trending_videos"><i class="fa fa-fire"></i></i>Trending</a>
                         <input type="hidden" name="number" id="id_number" value="0" >
                        <a><i class="fa fa-fire" title="following link"></i></i>Following</a>
                    </li>
                    <hr class="hr-border">  
                    <li class="has-submenu" data-dropdown-menu="example1">
                        <a href="javascript::void(0);"><i class="fa fa-th"></i>category</a>
                    ...
                    <div class="top-button">
                        <ul class="menu loginMenu">
                            ...
                            @if(empty(Auth::user()->id))
                            <li class="dropdown-login">
                                <a href="{{ route('login') }}" title="login/register link">login/Register</a>
                            </li>
                            @endif
                        </ul>
                    </div>
...
<div class="class-rederHtml"></div>
                                    ...
                                    <div class="image {{ $recentVideos->id }}" >
                                         <div class="large-12 columns inner-flex-video" style="padding-top: 0px !important;padding-bottom: 0px !important;">
                                            <div class="flex-video widescreen">
                                                <video id="video_play_id{{$recentVideos->id }}" title="{{$recentVideos->title }}" alt="{{$recentVideos->title }}" width="925px" height="481px"class="video-js vjs-default-skin video_palyerclass" controls preload="auto"data-setup="{}">
                                                <source src="{{asset('storage')}}/{{ $recentVideos->video_file }}" alt="{{$recentVideos->title}}" title="{{$recentVideos->title}}" type='video/mp4'>
                                              </video>
                                              <source src="{{asset('storage')}}/{{ $recentVideos->video_file }}"  alt="{{$recentVideos->title}}" title="{{$recentVideos->title}}"type="video/mp4" label="720P">
                                                <source src="{{asset('storage')}}/{{ $recentVideos->video_file }}"  alt="{{$recentVideos->title}}"title="{{$recentVideos->title}}" type="video/mp4" label="480P" selected="true">
                                                <source src="{{asset('storage')}}/{{ $recentVideos->video_file }}" alt="{{$recentVideos->title}}" title="{{$recentVideos->title}}" type="video/mp4" label="360P">
                                                <source src="{{asset('storage')}}/{{ $recentVideos->video_file }}" alt="{{$recentVideos->title}}" title="{{$recentVideos->title}}" type="video/mp4" label="240P">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @if(!empty($getLatestUpload))
                                    @foreach($getLatestUpload as $recentVideos)
                                        <div class="ver-thumbnail image-margin" id="{{ $recentVideos->id }}" >
                                            <img src="{{asset('storage')}}/{{ $recentVideos->image_file }}" alt="{{ $recentVideos->title }} image">
                                            <div class="item-title">
                                                <span>{{ $recentVideos->getCategoryName->name }}</span>
                                                <h2>{{ $recentVideos->title }}</h2>
                                            </div>
                                        </div>
                                    @endforeach
                                @endif
                    ...
                    @foreach($allCategory as $category)
                        <div class="item-cat item thumb-border">
                            <figure class="premium-img">
                                <img src=" @if(!empty($category->category_banner)){{ asset('storage') }}/{{ 'category_banner/'.$category->category_banner }} @else http://placehold.it/185x130 @endif" alt="{{$category->name}} carousel">
                                <a  onclick="increase()" data-category_id="{{ $category->id }}" class="class_category hover-posts">
                                    <span><i class="fa fa-search"></i></span>
                                </a>
                            </figure>
                            <h4><a class="class_category" onclick="increase()" data-category_id="{{ $category->id }}" >{{ ucfirst($category->name) }}
                                </a></h4>
                        </div>
                    @endforeach
                @endif
                        ...
                        <div class="row padding-14 " >
                            ...
                            <div class="medium-4 small-4 columns">
                                <ul class="tabs text-right pull-right" data-tabs id="newVideos">
                                    <ul class="tabs text-right pull-right" data-tabs="q4vohi-tabs" id="popularVideos">
                                        <a class="class_category more_videos" onclick="increase()" data-category_id="popular">More &gt;&gt;</a>
                                    </ul>
                                                ...
                                                <div class="item large-3 medium-6 columns grid-default" style="float:left;">
                                                    <div class="post thumb-border">
                                                        <div class="post-thumb">
                                                            <img src="{{ asset('storage') }}/{{ $relVideo->image_file }}" alt="{{$relVideo->title}} landing">
                                ...
                                <div class="medium-4 small-4 columns">
                                   {{--  <ul class="tabs text-right pull-right" data-tabs id="popularVideos">
                                        <li class="tabs-title is-active">
                                            <a class="class_category" onclick="increase()" data-category_id="new_all">all</a></li> --}}
                                        {{-- <li class="tabs-title"><a href="#popular-hd">HD</a></li> --}}
                                    {{-- </ul> --}}
                                    <ul class="tabs text-right pull-right" data-tabs="q4vohi-tabs" id="popularVideos">
                                        <a class="class_category more_videos" onclick="increase()" data-category_id="new_all">More &gt;&gt;</a>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                            ...
                                            @foreach($lastSevenDaysMostViewsRecord as $treanding)
                                               {{-- @if($getVideoInfo->id != $treanding->id) --}}
                                                <div class="item large-3 medium-6 columns grid-default" style="float:left;">
                                                    <div class="post thumb-border">
                                                        <div class="post-thumb">
                                                            <img src="{{ asset('storage') }}/{{ $treanding->image_file }}" alt="{{$treanding->title}} landing">
                                                     ...
                                                     @foreach($category->getCategoryWiseVideo as $catVideos)
                                                       {{-- @if($getVideoInfo->id != $treanding->id) --}}
                                                        <div class="item large-3 medium-6 columns grid-default" style="float:left">
                                                            <div class="post thumb-border">
                                                                <div class="post-thumb">
                                                                    <img src="{{ asset('storage') }}/{{ $catVideos->image_file }}" alt="{{$catVideos->title}} landing">
    ...
    <div class="ajax-load text-center" style="display:none">
        <p><img src="http://demo.itsolutionstuff.com/plugin/loader.gif" alt="loading more video">Loading More video</p>           
    </div>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/videojs-socialShare.css') }}">
    <script type="text/javascript" src="{{asset('js/videojs-socialShare.js')}}"></script>
    <script type="text/javascript" src="{{asset('js/videojs-overlay.min.js')}}"></script>
    ...
    <link href="{{asset('css/seek-time.css')}}" rel="stylesheet"></script>
    <script type="text/javascript" src="{{asset('js/seek-time.js')}}"></script>
    <link href="{{ asset('css/quality-selector.css') }}" rel="stylesheet">
    <script type="text/javascript" src="{{asset('js/quality-selector.js')}}"></script>
...
/*video search load more data*/
   ...
   // videojs.getPlayer('myPlayerID').ready(function() {
        ...
        myPlayer =   videojs('video_play_id{{$recentVideos->id }}',{controls: true,autoplay: false,fluid:true,responsive: true,fill:true});
        ...
        myPlayer.src([
           {
              src: "{{asset('storage')}}/{{ $recentVideos->video_file }}",
              type: 'video/mp4',
              label: '720P',
           },
           {
        ...
        function resizeVideoJS(){
         ...
         options = {
                "title": "{{isset($recentVideos->title)? $recentVideos->title:'video title'}}",
                "description": "{{isset($recentVideos->description)? clean($recentVideos->description):'video title'}}",
                "url": "{{url('video/watch/'.base64_encode($recentVideos->id))}}",
                "embedCode": "<iframe src='{{url('video/watch/'.base64_encode($recentVideos->id))}}'>",
                "offset": "{{isset($recentVideos->video_length)?$recentVideos->video_length:'00:00:00'}}",
                "services": {
                    "facebook": true,
                    "twitter": true,
                    "linkedin": true,
...
/*only play single video in frame script*/
    ...
    $(document).ready(function() {
     ...
     var obj = {
            ...
            searchSuggestion:function(data){
                $.ajax({
                    ...
                    success:function(r){
                        ...
                        $('#searchSuggestion').html(r);
                        
                    }
                });
            },
            headerSearchSuggestion:function(data){
                $.ajax({
                    url: data.action,
                    type:"get",
                    data: data,
                    success:function(r){
                        $('#header_searchSuggestion').fadeIn();  
                        $('#header_searchSuggestion').html(r);
        ...
        //     jQuery(document).on('clik','.typeahead',function() {
        //         var query =  $('.typeahead').val();
        ...
        jQuery(document).ready(function() {
            jQuery(document).on('keyup','.typeahead',function() {
                var query =  $('.typeahead').val();
               //var _token = $("input[name='_token']").val();
                var action = "{{ route('videoSearchAutocomplete') }}";
                var data = {query:query,target:'#add_render_html',action:action};
                obj.searchSuggestion(data);
            });
        });

         jQuery(document).ready(function() {
            jQuery(document).on('keyup','.typeahead_header_search',function() {
                var query =  $('.typeahead_header_search').val();
               //var _token = $("input[name='_token']").val();
                var action = "{{ route('videoSearchAutocomplete') }}";
                var data = {query:query,target:'#add_render_html',action:action};
                obj.headerSearchSuggestion(data);
            });
        });

        jQuery(document).ready(function() { 
            jQuery(document).on('click','.search_result_data',function() {
                $('#searchSuggestion').hide(); 
                var type = $(this).data('type');
                var id = $(this).data('id');
                var query = $(this).data('query');
                var action = "{{ route('videoSearch') }}";
                var data = {type:type,id:id,target:'#add_render_html',query:query,action:action};
                obj.WelcomePage(data);
            });
        });

        jQuery(document).ready(function() { 
            jQuery(document).on('click','.header_search_data',function() {
                $('#header_searchSuggestion').hide(); 
                var type = $(this).data('type');
                var header = "header";
                var id = $(this).data('id');
                var query = $(this).data('query');
         ...
         jQuery(document).ready(function() { 
            jQuery(document).on('click','.result_search_buttton',function() {
                $('#searchSuggestion').hide(); 
                var query = $('#id_search_textbox').val();
                var type = "button_search";
                var action = "{{ route('videoSearch') }}";
                var data = {type:type,id:"",target:'#add_render_html',query:query,action:action};
                obj.WelcomePage(data);
            });
        });
