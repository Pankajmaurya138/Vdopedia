                    ...
                    <div class="row secBg">
                        <div class="large-12 columns inner-flex-video">
                            <div class="flex-video widescreen">
                                ...
                                <source src="{{asset('storage')}}/{{ $getVideoInfo->video_file }}" type="video/mp4" label="720P">
                                <source src="{{asset('storage')}}/{{ $getVideoInfo->video_file }}" type="video/mp4" label="480P" selected="true">
                                <source src="{{asset('storage')}}/{{ $getVideoInfo->video_file }}" type="video/mp4" label="360P">
                                <source src="{{asset('storage')}}/{{ $getVideoInfo->video_file }}" type="video/mp4" label="240P">
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="social-share">
                                <div class="post-like-btn clearfix">
                                   ...
                                   {{-- <a class="secondary-button css_on_single_page" data-toggle="tooltip" data-placement="top" title="download pdf file"><i class="fa fa-file-pdf-o"> </i></a> --}} 
                                    ...
                                    <!-- <div class="float-right easy-share" data-easyshare-title="Checkout Sharer.js!" data-easyshare data-easyshare-http data-easyshare-url="http://vdopedia.com">
                        ...
                        <div class="media-object stack-for-small">
                            <div class="media-object-section comment-img text-center">
                                <div class="comment-box-img">
                                    <img src= "@if(!empty(Auth::user()->profile_image)) {{ asset('storage').'/'.Auth::user()->profile_image }} @else {{ asset('storage').'/images/user.png' }} @endif" alt="comment">
                                </div>
...
@section('script')
    ...
    <link href="{{ asset('css/videojs-playlist.css') }}" rel="stylesheet">
    ...
    <script type="text/javascript" src="{{asset('js/videojs-playlist.min.js')}}"></script>
   <!-- <script src="https://unpkg.com/silvermine-videojs-quality-selector/dist/js/silvermine-videojs-quality-selector.min.js"></script> -->
    ...
    $(document).ready(function(){
         var myPlayer,
        overlayDisplayed;
        myPlayer =   videojs('id-iframe',{ preload: true, techOrder: ["youtube", "html5"]},{controls: true,autoplay: false,responsive: true,fill:true});
        var aspectRatio = 9/16; 
        var videosList = [
        <?php 
        foreach ($getRecentVideos as $key => $value) { ?>
            { 
               
              "src" : "{{asset('storage')}}/{{ $value->video_file }}",
              "type": "video/mp4",
              "title": "{{ $value->title }}",
              "thumbnail": "{{ $value->image_file }}"
            },
            <?php
        }
            ?>
          ];
          myPlayer.playlist({ videos: videosList, playlist: { hideSidebar: false, upNext: true, hideIcons: false, thumbnailSize: 300, items: 3 } });
