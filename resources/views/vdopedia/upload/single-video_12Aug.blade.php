                    ...
                    <div class="row secBg">
                        <div class="large-12 columns inner-flex-video">
                            <div class="flex-video widescreen">
                                ...
                                <video id="id-iframe"  width="770px" height="480px"    class="video-js vjs-default-skin video_palyerclass" controls preload="auto" data-setup='{ "asdf": true }'>
...
@section('script')
   ...
   <!-- <script src="https://unpkg.com/silvermine-videojs-quality-selector/dist/js/silvermine-videojs-quality-selector.min.js"></script> -->
    ...
    $(document).ready(function(){
         var myPlayer,
        overlayDisplayed;
        myPlayer =   videojs('id-iframe',{controls: true,autoplay: false,fluid:true,});
