           ...
           <?php } ?>
            <div class="media-object-section comment-desc">
                ...
                <div class="comment-title">
                    <span class="name"><a href="{{ url('profile/'.base64_encode($comment->getUser->id)) }}">{{ $comment->getUser->name }}</a> Said:</span>
                ...
                @if(isset($comment->getReplies))
                	...
                	<!--sub comment-->
    		            <div class="media-object stack-for-small reply-comment">
    		                ...
    		                <div class="media-object-section comment-desc">
    		                    <div class="comment-title">
    		                        <span class="name"><a href="{{ url('profile/'.base64_encode($reply->getUser->id)) }}">{{ $reply->getUser->name }}</a> Said:</span>
