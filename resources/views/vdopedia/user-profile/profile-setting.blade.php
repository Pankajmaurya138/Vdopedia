                        ...
                        <div class="setting-form">
                            <form  id="profileSettingsForm" enctype="multipart/form-data">
                                ...
                                <div class="setting-form-inner">
                                    <div class="row">
                                        <div class="large-12 columns">
                                            <h5 class="borderBottom">About Me:</h5>
                                        </div>
                                        <div class="medium-6 columns">
                                            <label>Email ID:
                                                <input type="email" value="{{ $userInfo->email }}" readonly="readonly"  name="email" placeholder="enter your email address..">
                                            </label>
                                ...
                                <div class="setting-form-inner">
                                    <div class="row">
                                        <div class="large-12 columns">
                                            <h4 class="borderBottom">Profile Image:</h4>
                                        </div>
                                        <div class="large-12 columns">
                                            <div class="medium-6 columns">
                                            ...
                                            <div class="medium-6 columns end">
                                                <div id="image" style="display: block; border: 1px solid gray;" >
                                                    <img id="id-profileimage" name="profile" class="class-image" src=" @if($userInfo->profile_image){{asset('storage')  }}/{{ $userInfo->profile_image  }}@else {{asset('storage')  }}/{{ 'images/user.png'  }} @endif" style="width:400px; height:150px" alt="author image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="large-12 columns">
                                            <h3 class="borderBottom"> Background Image:</h3>
                                            <div class="medium-6 columns" style="float: left;">
                                           ...
                                           <div class="medium-6 columns end">
                                                <div id="background" style="display: block; border: 1px solid gray;" >
                                                    <img id="id-background" class="class-image" alt="author image" src=" @if($userInfo->profile_image){{asset('storage')  }}/{{ $userInfo->background_image  }}@else {{asset('storage')  }}/{{ 'images/user.png'  }} @endif" style="width:400px; height:150px">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
