      ...
      <div class="media-object stack-for-small">
        ...
        <div class="media-object-section comment-img text-center">
            <div class="comment-box-img">
                <img src= " @if(!empty($comment->user->profile_image)) {{ asset('storage') }}/{{ $comment->user->profile_image }} @else {{ asset('storage').'/images/user.png' }} @endif" alt="profile image">
            </div>
        </div>
        @endif
                    ...
                    <div class="media-object stack-for-small reply-comment">
                        ...
                        <div class="media-object-section comment-desc">
                            ...
                            <div class="comment-btns">
                                ...
                                <span>
                                    <a class="reply-class" data-name="{{ ucfirst($reply->user->name) }}" data-id="{{ $reply->video_id }}" data-user_id="{{ Auth::user()->id}}" data-image="{{ asset('storage') }}/{{  Auth::user()->profile_image }}" data-video_id="{{ $reply->video_id }}" data-reply="yes" data-parent_id="{{ $reply->id }}"><i class="fa fa-share"></i>Reply</a>
                                </span>
                            </div>
                        </div>
                    </div><!-- end sub comment -->
