<div id="trending">
                ...
                <div class="light-off-menu" id="offCanvas" data-off-canvas style="overflow-y: scroll; height:450px;">
                    <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
                        <li class="has-submenu">
                            ...
                            <a data-toggle="tooltip" data-placement="bottom" title="trending videos"  data-video_status="trending" onclick="increase()" class="trending_videos"><i class="fa fa-fire"></i>Trending</a>
                            <input type="hidden" name="number" id="id_number" value="0" >
                            <a data-toggle="tooltip" data-placement="bottom" title="following category"><i class="fa fa-fire"></i>Following</a>
                        </li>
                        <hr class="hr-border">
                                    ...
                                    <div class="widgetBox clearfix">
                                        ...
                                        <div class="widgetContent clearfix">
                                            <ul>
                                                @if(isset($allCategory))
                                                    @foreach($allCategory as $category)
                                                        <li class="cat-item"><a class="class_category" onclick="increase()" data-category_id="{{ $category->id }}" >{{ ucfirst($category->name) }}&nbsp; ({{count($category->getCategoryAllVideoCount) }})
                                                        </a></li>
                                                    @endforeach
                                                @endif
    ...
    @endsection
    @section('script')
        <div class="remove_single_page_script">
        ...
        <script type="text/javascript" >
            var obj = {
                    ...
                    categoryWiseFilter:function(data) {
                            ...
                            $.ajax({
                                    url: {{ url('/video/watch/render') }},
                                    type: 'get',
                                    data: {category_id:res.category_id},
                                    success:function(r){
                                    $('.remove_single_page_script').html('');
                                    $('#trending').html('');
                                   

                                    $('#trending').html(r.html);
