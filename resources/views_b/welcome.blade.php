                                                ...
                                                <div class="image {{ $recentVideos->id }}" >
                                                     <div class="large-12 columns inner-flex-video" style="padding-top: 0px !important;padding-bottom: 0px !important;">
                                                        <div class="flex-video widescreen">
                                                            <video id="video_play_id{{$recentVideos->id }}" title="{{$recentVideos->title}}" width="925px" height="481px"class="video-js vjs-default-skin video_palyerclass" controls preload="auto"data-setup="{}">
                            ...
                            @foreach($allCategory as $category)
                                <div class="item-cat item thumb-border">
                                    <figure class="premium-img">
                                        <img src=" @if(!empty($category->category_banner)){{ asset('storage') }}/{{ 'category_banner/'.$category->category_banner }} @else http://placehold.it/185x130 @endif" alt="{{ $category->name }}_carousel">
