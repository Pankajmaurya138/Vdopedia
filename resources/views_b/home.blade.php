...
<!-- my Menu -->
                ...
                <div class="top-bar-left toplogo">
                    <ul class="menu">
                        <li class="menu-text">
                            <a href="@if(!empty(Auth::user()->id)){{ route('home')}} @else {{ url('/') }} @endif">
                        ...
                        <div class="top-button">
                            <ul class="menu float-left" style="margin-top: 5px;" >
                                ...
                                <li class="dropdown-login">
                                    <a class="loginReg" data-toggle="example-dropdown" href="{{route('login')}}">login/Register</a>
                                        ...
                                        <form method="post" data-abide novalidate action="{{ route('login') }}">
                                            @csrf
                                                <div class="input-group">
                                                    ...
                                                    <input class="input-group-field" name="email" type="email" value="{{ old('email') }}" placeholder="Enter your email" >
                                                </div>
                                                @if ($errors->has('email'))
                        ...
                        <div class="main-image player-width">
                            @if(!empty($getLatestUpload))
                                @foreach($getLatestUpload as $recentVideos)
                                    <div class="image {{ $recentVideos->id }}" alt="{{$recentVideos->titles}}" >
                                         <div class="large-12 columns inner-flex-video" style="padding-top: 0px !important;padding-bottom: 0px !important;">
                                            <div class="flex-video widescreen">
                                                <video id="video_play_id{{$recentVideos->id }}" title="{{$recentVideos->title
                                                }}" width="925px" height="481px"class="video-js vjs-default-skin video_palyerclass" controls preload="auto"data-setup="{}">
                                                <source src="{{asset('storage')}}/{{ $recentVideos->video_file }}" title="{{$recentVideos->title}}" type='video/mp4'>
                                              </video>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if(!empty($getLatestUpload))
                                    @foreach($getLatestUpload as $recentVideos)
                                        <div class="ver-thumbnail image-margin" id="{{ $recentVideos->id }}" >
                                            <img src="{{asset('storage')}}/{{ $recentVideos->image_file }}" alt="{{ $recentVideos->title}}">
                            ...
                            @foreach($allCategory as $category)
                                <div class="item-cat item thumb-border">
                                    <figure class="premium-img">
                                        <img src=" @if(!empty($category->category_banner)){{ asset('storage') }}/{{ 'category_banner/'.$category->category_banner }} @else http://placehold.it/185x130 @endif" alt="{{ ucfirst($category->name) }}_carousel">
                                                        ...
                                                        <div class="item large-3 medium-6 columns grid-default" style="float:left;">
                                                            <div class="post thumb-border">
                                                                <div class="post-thumb">
                                                                    ...
                                                                    <img src="{{ asset('storage') }}/{{ $relVideo->image_file }}" alt="{{$relVideo->title}}_landing">
                                                    ...
                                                    @foreach($lastSevenDaysMostViewsRecord as $treanding)
                                                       {{-- @if($getVideoInfo->id != $treanding->id) --}}
                                                        <div class="item large-3 medium-6 columns grid-default" style="float:left;">
                                                            <div class="post thumb-border">
                                                                <div class="post-thumb">
                                                                    <img src="{{ asset('storage') }}/{{ $treanding->image_file }}" alt="{{$treanding->title}}_landing">
                                                             ...
                                                             @foreach($category->getCategoryWiseVideo as $catVideos)
                                                               {{-- @if($getVideoInfo->id != $treanding->id) --}}
                                                                <div class="item large-3 medium-6 columns grid-default" style="float:left">
                                                                    <div class="post thumb-border">
                                                                        <div class="post-thumb">
                                                                            <img src="{{ asset('storage') }}/{{ $catVideos->image_file }}" alt="{{$catVideos->title}}_landing">
